...
class TimeUtility():
                ...
                for n in range(0, len(monthlist[0])):
                    ...
                    if (monthFirstTime == monthrange[0] and
                        ...
                        if monthLength == lastDayOfMonth:
                            ...
                            # time axis doesnt contains day waise time series.
    ...
    def _getDayCountOfYear(self, date, year=None, calendarName=None):
        ...
        return int(daycount)
    # end of def getDayCountOfYear(self, date, calendarName=None):
    ...
    def getSeasonalData(self, varName, fpath, sday, smon, eday, emon, hr=0):
        ...
        allYearSeasonalData = numpy.array([0])
        ...
        for year in avlyears:
            ...
            if allYearSeasonalData.shape == (1,):
                ...
                # get the time axis index of this first seasonal data
                seasonalTimeIdx = allYearSeasonalData.getTime()[:]
                # append to the allYearSeasonalTimeIdx array
                allYearSeasonalTimeIdx = numpy.append(allYearSeasonalData,
                                                           seasonalTimeIdx)
            # end of if allYearSeasonalData.shape == (1,):
        ...
        axislist = [newTAxis, latAxis, lonAxis]
        if levAxis: axislist.insert(1, levAxis)
    ...
    def getSummerData(self, varName, fpath, sday=1, smon=5, eday=31, emon=10, hr=0):
        """
        ...
        return self.getSeasonalData(varName, fpath, sday, smon, eday, emon, hr)
    # end of def summerVariance(...):


    def getWinterData(self, varName, fpath, sday=1, smon=11, eday=30, emon=4, hr=0):
        """
